...
export function saveConstruction(http: HttpClient, rootUrl: string, params: SaveConstruction$Params, context?: HttpContext): Observable<StrictHttpResponse<Construction>> {
