...
public class AuthenticationService {
    ...
    public ResponseEntity<String> activateAccountByAdmin(Contactor contactor){
    ...
    public ResponseEntity<String> disableAccountWorkerByAdmin(Worker worker){
    ...
    public ResponseEntity<String> activateAccountWorkerByAdmin(Worker worker){
        User user = this.userRepository.findByEmail(worker.getEmail());
        user.setEnabled(true);
        userRepository.save(user);
        return ResponseEntity.ok("Compte utilisateur a été activer");
    ...
    public ResponseEntity<String> disableAccountByAdmin(Contactor contactor){
        User user = this.userRepository.findByEmail(contactor.getEmail());
        user.setEnabled(false);
        userRepository.save(user);
        return ResponseEntity.ok("Compte utilisateur a été désactiver");
